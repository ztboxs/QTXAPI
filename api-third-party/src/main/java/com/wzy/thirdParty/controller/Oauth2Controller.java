...
public class Oauth2Controller {
    ...
    public String gitee(@RequestParam("code") String code, HttpServletResponse res) throws IOException {
        ...
        try {
            ...
            return  "redirect:http://106.13.211.93/user/login";
        }
        if (response.getStatus() == 200){
            ...
            if (cookieResUtils(res, baseResponse)) return "redirect:http://106.13.211.93/user/login";
        }
        return "redirect:http://106.13.211.93";
    }
